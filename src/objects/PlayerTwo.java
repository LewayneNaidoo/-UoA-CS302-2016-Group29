...
public class PlayerTwo{
	...
	public PlayerTwo(int x, int y, double direction, boolean isPrimary) {
		// change to enums
		this.x = x;
		this.y = y;
		...
		try 
		{
			originalTankImage = ImageIO.read(new File ("C:\\Users\\King\\workspace\\Compsys302_Project\\res\\playerTwoTank.png"));
